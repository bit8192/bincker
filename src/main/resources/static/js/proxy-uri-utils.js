/**
 * 通过Clash Verge Rev项目代码改动得来
 * @see https://github.com/clash-verge-rev/clash-verge-rev/blob/main/src/utils/uri-parser.ts
 */
(function(){
    const ProxyUriUtils = {};
    ProxyUriUtils.parseUri = function parseUri(uri) {
    ...
    (window || global).ProxyUriUtils = ProxyUriUtils;
})()
